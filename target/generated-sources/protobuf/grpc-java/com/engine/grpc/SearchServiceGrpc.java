...
public final class SearchServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "engine.SearchService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.engine.grpc.SearchRequest,
      com.engine.grpc.SearchResponse> getSearchMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Search",
      requestType = com.engine.grpc.SearchRequest.class,
      responseType = com.engine.grpc.SearchResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.engine.grpc.SearchRequest,
      com.engine.grpc.SearchResponse> getSearchMethod() {
    io.grpc.MethodDescriptor<com.engine.grpc.SearchRequest, com.engine.grpc.SearchResponse> getSearchMethod;
      ...
      synchronized (SearchServiceGrpc.class) {
        if ((getSearchMethod = SearchServiceGrpc.getSearchMethod) == null) {
          SearchServiceGrpc.getSearchMethod = getSearchMethod =
              io.grpc.MethodDescriptor.<com.engine.grpc.SearchRequest, com.engine.grpc.SearchResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Search"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.engine.grpc.SearchRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.engine.grpc.SearchResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void search(com.engine.grpc.SearchRequest request,
        io.grpc.stub.StreamObserver<com.engine.grpc.SearchResponse> responseObserver) {
  ...
  public static final class SearchServiceStub
    ...
    /**
     */
    public void search(com.engine.grpc.SearchRequest request,
        io.grpc.stub.StreamObserver<com.engine.grpc.SearchResponse> responseObserver) {
  ...
  public static final class SearchServiceBlockingStub
    ...
    /**
     */
    public com.engine.grpc.SearchResponse search(com.engine.grpc.SearchRequest request) {
  ...
  public static final class SearchServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.engine.grpc.SearchResponse> search(
        com.engine.grpc.SearchRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEARCH:
          serviceImpl.search((com.engine.grpc.SearchRequest) request,
              (io.grpc.stub.StreamObserver<com.engine.grpc.SearchResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.engine.grpc.SearchRequest,
              com.engine.grpc.SearchResponse>(
  ...
  private static abstract class SearchServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.engine.grpc.SearchProto.getDescriptor();
    }
